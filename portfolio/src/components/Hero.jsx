  ...
  return (
    <section id="top" aria-label="Introduction" className="relative">
      ...
      >
        ...
        <motion.p variants={item} className="font-hand mt-6 text-lg text-muted">
        ...
        <motion.a
          variants={item}
          href="#work"
          className="font-hand mt-14 inline-flex items-center gap-2 text-lg text-sage hover:text-cream"
        >
