  ...
  return (
    <footer id="connect" className="mt-10 border-t border-line">
      <div className="mx-auto max-w-3xl px-6 pb-14 pt-12 text-center">
        <p className="font-hand text-lg text-sage">say hello</p>
        <div className="mt-6 flex items-center justify-center gap-8">
          {socials.map(({ label, href, Icon }) => (
            <a
              ...
              aria-label={label}
              title={label}
              className="text-cream transition-colors hover:text-sage"
            >
...
export default function App() {
  return (
    <div className="grain">
      ...
      <a
        href="#main"
        className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-50 focus:rounded focus:bg-sage focus:px-4 focus:py-2 focus:text-cream"
      >
        Skip to content
      </a>
      <Nav />
